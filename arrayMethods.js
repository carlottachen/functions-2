...
// CODE HERE
const evenNumbers = mixedNumbers.filter(function(evenNum){
	return evenNum % 2 === 0;
});
...
// CODE HERE
const newPrices = orders.map(function(element){
//	element = element.price + element.tax;
//	console.log(`${element}`)
	return element = element.price + element.tax;
});
...
const bobPrices = purchases.filter(function(elem){
